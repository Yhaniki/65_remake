...
三個概念先講清楚(這是所有坑的來源):
  ...
  4. 檔案寫到哪:目錄表(歌單/難度/歌名)永遠進 StreamingAssets;譜面/音樂/試聽/舞蹈/封面這些
...
from remove_songs import (OVERRIDES_CSV, OVERRIDES_JSON, CATALOG,                # noqa: E402
                          data_trees, runtime_tree, load_catalog, remove_stems, stem)
